...
import com.hemanth.kotlinCoroutines.eachCoroutineExample.task.onetask.LongRunningTaskViewModel
import com.hemanth.kotlinCoroutines.eachCoroutineExample.task.twotask.TwoLongRunningTasksViewModel
import com.hemanth.kotlinCoroutines.eachCoroutineExample.timeout.TimeoutViewModel

class ViewModelFactory(private val apiHelper: ApiHelper?=null, private val dbHelper: DatabaseHelper?=null) :
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        ...
        if (modelClass.isAssignableFrom(LongRunningTaskViewModel::class.java)) {
            return LongRunningTaskViewModel() as T
        }
        if (modelClass.isAssignableFrom(TwoLongRunningTasksViewModel::class.java)) {
            return TwoLongRunningTasksViewModel() as T
        }
